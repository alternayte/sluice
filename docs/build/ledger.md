...
| REQ-API-003 | PASS | S0 | SCN-API-003 |
| REQ-API-004 | PASS | S0 | SCN-API-004 |
...
| REQ-AUTH-005 | PASS | S1 | SCN-AUTH-005 |
...
| REQ-NS-006 | PASS | S3 | SCN-NS-006 |
| REQ-NS-007 | IN_PROGRESS | S3 |  |
| REQ-NS-008 | PASS | S3 | SCN-NS-008 |
...
| REQ-EXE-001 | PASS | S4 | SCN-EXE-001 |
| REQ-EXE-002 | PASS | S4 | SCN-EXE-002 |
| REQ-EXE-003 | PASS | S4 | SCN-EXE-003 |
| REQ-EXE-004 | PASS | S4 | SCN-EXE-004 |
| REQ-EXE-005 | PASS | S4 | SCN-EXE-005 |
| REQ-EXE-006 | PASS | S4 | SCN-EXE-006 |
| REQ-EXE-007 | PASS | S4 | SCN-EXE-007 |
| REQ-EXE-008 | IN_PROGRESS | S4 |  |
| REQ-EXE-009 | IN_PROGRESS | S4 |  |
| REQ-EXE-010 | IN_PROGRESS | S4 |  |
| REQ-EXE-011 | PASS | S4 | SCN-EXE-011 |
| REQ-EXE-012 | IN_PROGRESS | S4 |  |
| REQ-EXE-013 | PASS | S4 | SCN-EXE-013 |
| REQ-EXE-014 | IN_PROGRESS | S4 |  |
| REQ-EXE-015 | PASS | S4 | SCN-EXE-015 |
| REQ-EXE-016 | PASS | S4 | SCN-EXE-013; SCN-EXE-016 |
| REQ-EXE-017 | PASS | S4 | SCN-EXE-017 |
| REQ-EXR-001 | IN_PROGRESS | S4 |  |
| REQ-EXR-002 | IN_PROGRESS | S4 |  |
| REQ-EXR-003 | PASS | S4 | SCN-EXR-002 |
| REQ-EXR-008 | PASS | S4 | SCN-EXR-008 |
| REQ-RUN-001 | PASS | S4 | SCN-RUN-001 |
| REQ-RUN-002 | PASS | S4 | SCN-RUN-001; SCN-RUN-002 |
| REQ-RUN-003 | PASS | S4 | SCN-RUN-003 |
| REQ-RUN-004 | PASS | S4 | SCN-RUN-004 |
| REQ-RUN-005 | IN_PROGRESS | S4 |  |
| REQ-RUN-006 | IN_PROGRESS | S4 |  |
| REQ-RUN-007 | IN_PROGRESS | S4 |  |
| REQ-RUN-008 | IN_PROGRESS | S4 |  |
| REQ-RUN-009 | PASS | S4 | SCN-RUN-009 |
| REQ-RUN-010 | PASS | S4 | SCN-RUN-010 |
| REQ-TRG-001 | PASS | S4 | SCN-TRG-001 |
| REQ-UI-004 | IN_PROGRESS | S4 |  |
| REQ-UI-005 | IN_PROGRESS | S4 |  |
| REQ-UI-012 | IN_PROGRESS | S4 |  |
| NFR-002 | IN_PROGRESS | S4 |  |
| SI-04 | PASS | S4 | SCN-RUN-010 |
