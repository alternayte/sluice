...
const driverLabels: Record<string, string> = { postgres: "Postgres", fs: "File system", s3: "S3 compatible", azblob: "Azure Blob" };
...
export function StoragePage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <PageHeader title="Storage" description="Object storage for file contents, bundles, logs and artifacts. Environment variables set the driver." />
